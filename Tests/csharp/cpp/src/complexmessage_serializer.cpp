...
// File: ComplexMessage_serializer.cpp
// Language: Cpp
...
int ComplexMessageSerializer::hash_code() const {
    return static_cast<int>(std::hash<std::string>{}("ComplexMessage"));
}

void ComplexMessageSerializer::write(const void* obj, StreamWriter& writer) const {
    const auto& message = *static_cast<const ComplexMessage*>(obj);
    BitMask mask;

    // Bit mask group 0
    mask.set_bit(0, !is_default_string(message.field1));
    mask.set_bit(1, !is_default_string(message.field2));
    mask.set_bit(2, !is_default_string(message.field3));
    mask.set_bit(3, !is_default_string(message.field4));
    mask.set_bit(4, !is_default_string(message.field5));
    mask.set_bit(5, !is_default_string(message.field6));
    mask.set_bit(6, !is_default_string(message.field7));
    mask.set_bit(7, !is_default_string(message.field8));
    mask.set_bit(8, !is_default_string(message.field9));
    mask.set_bit(9, !is_default_string(message.field10));
    mask.set_bit(10, !is_default_string(message.field11));
    mask.set_bit(11, !is_default_string(message.field12));
    mask.set_bit(12, !is_default_string(message.field13));
    mask.set_bit(13, !is_default_string(message.field14));
    mask.set_bit(14, !is_default_string(message.field15));
    mask.set_bit(15, !is_default_string(message.field16));
    mask.set_bit(16, !is_default_string(message.field17));
    mask.set_bit(17, !is_default_string(message.field18));
    mask.set_bit(18, !is_default_string(message.field19));
    mask.set_bit(19, !is_default_string(message.field20));
    mask.set_bit(20, !is_default_string(message.field21));
    mask.set_bit(21, !is_default_string(message.field22));
    mask.set_bit(22, !is_default_string(message.field23));
    mask.set_bit(23, !is_default_string(message.field24));
    mask.set_bit(24, !is_default_string(message.field25));
    mask.set_bit(25, !is_default_string(message.field26));
    mask.set_bit(26, !is_default_string(message.field27));
    mask.set_bit(27, !is_default_string(message.field28));
    mask.set_bit(28, !is_default_string(message.field29));
    mask.set_bit(29, !is_default_string(message.field30));
    mask.set_bit(30, !is_default_string(message.field31));
    mask.set_bit(31, !is_default_string(message.field32));
    mask.write(writer);

    // Bit mask group 1
    mask.set_bit(0, !is_default_string(message.field33));
    mask.set_bit(1, !is_default_string(message.field34));
    mask.set_bit(2, !is_default_string(message.field35));
    mask.set_bit(3, !is_default_string(message.field36));
    mask.set_bit(4, !is_default_string(message.field37));
    mask.set_bit(5, !is_default_string(message.field38));
    mask.set_bit(6, !is_default_string(message.field39));
    mask.set_bit(7, !is_default_string(message.field40));
    mask.write(writer);
...
void* ComplexMessageSerializer::read(StreamReader& reader) const {
...
bool ComplexMessageSerializer::is_default_string(const std::string& value) const {
    return value == "";
}
