...
namespace Example.Protocol.Serialization
{
    public class UserSerializer : ITypeHandler
    {
        ...
        private static readonly UserSerializer _instance = new UserSerializer();

        public static void Write(User obj, BitRPC.Serialization.StreamWriter writer)
        {
            _instance.Write(obj, writer);
        }

        public static User ReadStatic(BitRPC.Serialization.StreamReader reader)
        {
            return (User)_instance.Read(reader);
        }
