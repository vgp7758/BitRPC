...
{
    public class EchoRequestSerializer : ITypeHandler
    {
        ...
        private static readonly EchoRequestSerializer _instance = new EchoRequestSerializer();

        public static void Write(EchoRequest obj, BitRPC.Serialization.StreamWriter writer)
        {
            _instance.Write(obj, writer);
        }

        public static EchoRequest ReadStatic(BitRPC.Serialization.StreamReader reader)
        {
            return (EchoRequest)_instance.Read(reader);
        }
